...
| Phase 1 artifact path | `foundry/broadcast/DeployOptimismSepoliaPhase1.s.sol/11155420/run-latest.json` |
| Core artifact path | `foundry/broadcast/DeployFullSystemDirect.s.sol/11155420/run-latest.json` |
| M2M artifact path | `foundry/broadcast/DeployM2MSystem.s.sol/11155420/run-latest.json` |
| Timelock execution artifact path | `foundry/broadcast/ExecuteTimelockSetDelegationManager.s.sol/11155420/run-latest.json` |
...
Optimism Sepolia starter-kit assets: `ORI=0xD87493f4C02aad2c67Ce12aa534d188Bf44FCcAB`, `USDT.t=0x11E6c8f2806b32dAC427E7Df07F67602647eF87A`, `USDC.t=0xD6E84789741Ea2DE727961cCB383454E4A845035`, `OrinaTestTokenFaucet=0xbbD53C18F4d9fb98AA6c4837ea0E8F221e1b5F0F`.

Governance note: Optimism Sepolia uses deployer EOA `0x282Be18838D7079C215F49749a9606d77e00888b` as timelock proposer/executor/admin with zero delay for testnet only. Optimism mainnet must redeploy with production multisig/Safe governance, a non-zero timelock delay, and a fresh address set.
...
| Namespace | `orina-atp-v3.5-avalanche-fuji-eoa-testnet-20260702` |
| Phase 1 artifact path | `foundry/broadcast/DeployAvalancheFujiPhase1.s.sol/43113/run-latest.json` |
| Core artifact path | `foundry/broadcast/DeployFullSystemDirect.s.sol/43113/run-latest.json` |
| M2M artifact path | `foundry/broadcast/DeployM2MSystem.s.sol/43113/run-latest.json` |
| Timelock execution artifact path | `foundry/broadcast/ExecuteTimelockSetDelegationManager.s.sol/43113/run-latest.json` |
...
Avalanche Fuji starter-kit assets: `ORI=0xD87493f4C02aad2c67Ce12aa534d188Bf44FCcAB`, `USDT.t=0x11E6c8f2806b32dAC427E7Df07F67602647eF87A`, `USDC.t=0xD6E84789741Ea2DE727961cCB383454E4A845035`, `OrinaTestTokenFaucet=0xbbD53C18F4d9fb98AA6c4837ea0E8F221e1b5F0F`.

Governance note: Avalanche Fuji uses deployer EOA `0x282Be18838D7079C215F49749a9606d77e00888b` as timelock proposer/executor/admin with zero delay for testnet only. Avalanche-C mainnet must redeploy with production multisig/Safe governance, a non-zero timelock delay, and a fresh address set.
...
| Namespace | `orina-atp-v3.5-worldchain-sepolia-eoa-testnet-20260702` |
| Phase 1 artifact path | `foundry/broadcast/DeployWorldchainSepoliaPhase1.s.sol/4801/run-latest.json` |
| Core artifact path | `foundry/broadcast/DeployFullSystemDirect.s.sol/4801/run-latest.json` |
| M2M artifact path | `foundry/broadcast/DeployM2MSystem.s.sol/4801/run-latest.json` |
| Timelock execution artifact path | `foundry/broadcast/ExecuteTimelockSetDelegationManager.s.sol/4801/run-latest.json` |
...
World Chain Sepolia starter-kit assets: `ORI=0xD87493f4C02aad2c67Ce12aa534d188Bf44FCcAB`, `USDT.t=0x11E6c8f2806b32dAC427E7Df07F67602647eF87A`, `USDC.t=0xD6E84789741Ea2DE727961cCB383454E4A845035`, `OrinaTestTokenFaucet=0xbbD53C18F4d9fb98AA6c4837ea0E8F221e1b5F0F`.

Governance note: World Chain Sepolia uses deployer EOA `0x282Be18838D7079C215F49749a9606d77e00888b` as timelock proposer/executor/admin with zero delay for testnet only. The first World Chain M2M pair `0x52440e44ec34a64e19b92243262fe47819d65539` / `0x7D6b498eDc3F469ED020116e8892EbB361753bCB` is orphaned because it used a stale Base Sepolia timelock; do not use it. World Chain mainnet chain `480` must redeploy with production multisig/Safe governance, a non-zero timelock delay, and a fresh address set.

## On-Chain Spot Checks

Checked on 2026-07-02:

- `MarketplaceATP`, `PaymentGateway`, and `DelegationManager` have deployed bytecode on BSC Testnet, Base Sepolia, Arbitrum Sepolia, Ethereum Sepolia, Optimism Sepolia, Avalanche Fuji, and World Chain Sepolia.
- BSC Testnet, Base Sepolia, Arbitrum Sepolia, Ethereum Sepolia, Optimism Sepolia, Avalanche Fuji, and World Chain Sepolia `MarketplaceATP.delegationManager()` return the listed DelegationManager.
- Each DelegationManager grants `CONSUMER_ROLE` to its listed Marketplace.
- Arbitrum Sepolia, Ethereum Sepolia, Optimism Sepolia, Avalanche Fuji, and World Chain Sepolia `DelegationManager.DEFAULT_ADMIN_ROLE` are held by their timelocks, not the deployer EOA; those timelocks themselves are EOA-controlled for testnet only.
