...
|---|---|---|---|
| **Phase 1 - Testnet Expansion** | Q3 2026 | BSC Testnet, Base Sepolia, Arbitrum Sepolia, Ethereum Sepolia, and Optimism Sepolia complete; Orbit Chain scheduled for Q4 2026 | Third-party audit of EVM contracts |
